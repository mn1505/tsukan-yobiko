// TSUKAN YOBIKO v3.1 data: question bank
...
QUESTION_BANK.push(...buildRefundAdditionalQuestionBankV31());
...
function buildRefundAdditionalQuestionBankV31() {
  const packId = "reinforce-59-kanzeihou-q1-refund-interest";
  const lessonId = "lesson-kanzeihou-refund-additional-money";
  const meta = {
  ...
  const rows = [
    ["001", "基礎", "trueFalse", "還付加算金は、関税の過誤納金を還付する場合に、還付すべき金額に加算される金額である。", ["正しい", "誤り"], "正しい", "還付加算金は、過誤納金の還付に付随して加算される金額です。", "延滞税のように納税者が追加で納めるものとして読むと誤ります。", "還付加算金"],
    ["002", "基礎", "singleChoice", "還付加算金の性格として最も適切なものはどれか。", ["還付すべき金額に加算するもの", "納付遅れに対して納税者が納めるもの", "無申告への制裁として課されるもの", "輸入許可の条件として常に納めるもの"], "還付すべき金額に加算するもの", "還付加算金は還付される側の金額に加算されるものです。", "延滞税・加算税・許可条件と混ぜた選択肢を除外します。", "還付・過誤納金"],
    ["003", "基礎", "trueFalse", "還付加算金は、延滞税と同じく、納税者の納付遅れに対して課される税である。", ["正しい", "誤り"], "誤り", "延滞税は納付遅れ、還付加算金は過誤納金の還付に加算される金額です。", "名称に税・加算が含まれる制度を同じ方向で読ませるひっかけです。", "延滞税・加算税"],
    ["004", "基礎", "singleChoice", "還付加算金の計算期間の終期として正しいものはどれか。", ["還付のため支払決定をする日", "支払命令をする日", "納期限", "輸入申告の日"], "還付のため支払決定をする日", "終期は、還付のため支払決定をする日として押さえます。", "支払命令日、納期限、申告日との入れ替えが典型です。", "支払決定日・支払命令日混同"],
    ["005", "基礎", "trueFalse", "還付加算金の割合は、年7.3%の割合として整理する。", ["正しい", "誤り"], "正しい", "還付加算金では年7.3%の割合を押さえます。", "年3.0%や年14.6%など、別制度の数字に引っ張られないようにします。", "還付加算金"],
    ["006", "標準", "singleChoice", "次のうち、還付加算金で最も混同しやすい日付の組合せはどれか。", ["支払決定日と支払命令日", "輸出許可日と積込日", "通関士確認日と登録日", "保税蔵置場の名称変更日と広告日"], "支払決定日と支払命令日", "還付加算金の終期では支払決定日が重要です。", "似た語感の支払命令日を正解に見せる問題に注意します。", "支払決定日・支払命令日混同"],
    ["007", "標準", "trueFalse", "還付加算金の終期を問われた場合、「支払命令をする日」とあれば正しいと判断する。", ["正しい", "誤り"], "誤り", "終期は支払決定をする日です。支払命令日ではありません。", "一字違いではなく、制度上の時点を入れ替えるひっかけです。", "支払決定日・支払命令日混同"],
    ["008", "標準", "singleChoice", "還付加算金の割合として選ぶべきものはどれか。", ["年7.3%", "年3.0%", "年14.6%", "年10.0%"], "年7.3%", "還付加算金の割合は年7.3%です。", "延滞税などで見た数字を混ぜる選択肢に注意します。", "選択肢読解"],
    ["009", "標準", "trueFalse", "更正・決定・賦課決定により過納金が生じた場合も、過納金の発生原因に応じて還付加算金の起算・基準日を確認する必要がある。", ["正しい", "誤り"], "正しい", "還付加算金は、過納金がどの原因で生じたかにより時点整理が必要です。", "どの過納金でも同じ日から計算すると決めつける選択肢に注意します。", "更正・決定"],
    ["010", "標準", "singleChoice", "更正の請求に基づく更正で生じた過納金について、判断の姿勢として正しいものはどれか。", ["請求日・更正日などの関係を比較して基準を確認する", "常に更正があった日だけを見る", "常に納期限だけを見る", "輸入許可日だけで決まる"], "請求日・更正日などの関係を比較して基準を確認する", "更正の請求に基づく更正では、複数の時点を比較する発想が重要です。", "更正日だけ、納期限だけと単純化するのがひっかけです。", "修正申告・更正の請求"],
    ["011", "標準", "trueFalse", "納税申告後の減額更正で過納金が生じた場合、納期限と納付があった日を文脈に応じて区別する必要がある。", ["正しい", "誤り"], "正しい", "納期限と納付日がどちらも選択肢に出るときは、過納金の原因と文脈を確認します。", "期限語を見た瞬間に納期限だけを選ぶ読み方は危険です。", "納税申告"],
    ["012", "標準", "singleChoice", "還付加算金の空欄補充で特に警戒すべき期間語の組合せはどれか。", ["1月・3月・1年", "2日・4日・6日", "5年・10年・20年", "午前・午後・夜間"], "1月・3月・1年", "還付加算金では1月、3月、1年の混同が狙われやすいです。", "数字だけで覚えず、起算点とセットで読む必要があります。", "期間・期限"],
    ["013", "応用", "trapCheck", "記述「還付加算金は、還付のため支払命令をする日までの期間に応じて計算する。」の問題点はどれか。", ["問題なし", "終期が誤り", "割合が誤り", "主体が誤り"], "終期が誤り", "終期は支払決定をする日です。", "支払命令という似た語句に置き換えるひっかけです。", "支払決定日・支払命令日混同"],
    ["014", "応用", "trapCheck", "記述「還付加算金の割合は年14.6%であり、延滞税と常に同じである。」の問題点はどれか。", ["問題なし", "割合と制度の性格が誤り", "支払決定日だけが誤り", "納税義務者だけが誤り"], "割合と制度の性格が誤り", "還付加算金の割合は年7.3%で、延滞税とは制度の向きも異なります。", "数字と制度名を同時に混同させる複合ひっかけです。", "延滞税・加算税"],
    ["015", "応用", "singleChoice", "更正の請求に基づく更正による過納金で、空欄補充問題を解くときの最初の作業はどれか。", ["請求があった日、更正があった日、一定期間の関係を整理する", "支払命令日だけを探す", "輸出許可の日だけを見る", "税率表番号を選ぶ"], "請求があった日、更正があった日、一定期間の関係を整理する", "更正の請求がある場合は、複数時点と期間の比較が重要です。", "ひとつの日付だけで処理させる選択肢に注意します。", "修正申告・更正の請求"],
    ["016", "応用", "trueFalse", "還付加算金では、過納金の種類を見ずに、すべて納付があった日の翌日から同じように計算すれば足りる。", ["正しい", "誤り"], "誤り", "過納金の発生原因により起算・基準日の整理が必要です。", "納付日というもっともらしい時点で全部を統一するひっかけです。", "還付・過誤納金"],
    ["017", "ひっかけ", "trapCheck", "記述「還付加算金は、納税者が納期限までに納付しなかった場合に国へ納める金額である。」の問題点はどれか。", ["問題なし", "延滞税との混同", "支払決定日だけが誤り", "選択肢数が誤り"], "延滞税との混同", "納付遅れで納税者が負担するのは延滞税の方向です。", "還付加算金と延滞税を逆向きにする典型です。", "延滞税・加算税"],
    ["018", "ひっかけ", "trapCheck", "記述「還付加算金の終期は、納期限または納付があった日のいずれか遅い日である。」の問題点はどれか。", ["問題なし", "終期が誤り", "割合が誤り", "科目が誤り"], "終期が誤り", "終期は還付のため支払決定をする日です。", "起算側で出る時点語を終期に持ち込むひっかけです。", "期間・期限"],
    ["019", "ひっかけ", "singleChoice", "空欄「還付加算金の計算期間は、一定の日から、還付のため＿＿＿までの期間で考える。」に入れる語句として最も適切なものはどれか。", ["支払決定をする日", "支払命令をする日", "納期限", "輸入許可の日"], "支払決定をする日", "終期の空欄は支払決定をする日です。", "支払命令という語感の近い選択肢を除外します。", "支払決定日・支払命令日混同"],
    ["020", "ひっかけ", "trapCheck", "記述「更正の請求に基づく更正では、請求があった日の翌日から起算する場面を考える必要はない。」の問題点はどれか。", ["問題なし", "更正の請求がある場合の時点整理が誤り", "還付加算金の割合だけが誤り", "保税制度との混同"], "更正の請求がある場合の時点整理が誤り", "更正の請求に基づく更正では、請求日・更正日・期間の比較を確認します。", "更正日だけで処理させ、請求日を消すひっかけです。", "修正申告・更正の請求"]
  ];
  return rows.map(([serial, difficulty, questionType, question, choices, answer, explanation, trapExplanation, weaknessTag]) => ({
    ...makeBankQuestion(`qb-kanzeihou-refund-additional-${serial}`, "関税法等", "還付加算金", lessonId, difficulty, questionType, question, choices, answer, explanation, trapExplanation, weaknessTag, "original"),
    ...meta
  }));
}
