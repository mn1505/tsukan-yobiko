...
v2.3は「通関実務 手順問題・計算問題追加版」です。インボイス読取、品目分類、課税価格、関税額、消費税・地方消費税、端数処理、申告書作成手順をローカル問題バンクで反復できるようにしています。
...
v2.3ではアプリ内通信を行いません。必要な場合は、アプリで相談文を作成し、外部ChatGPTに貼り付けて使います。
...
- 通関実務ドリル結果についての誤答分析相談文
- インボイス読取で間違いが多い場合の見る順番整理
- 関税額、消費税、地方消費税の計算順序整理
- 品目分類の判断手順確認
- 保税地域と保税運送の混同整理
